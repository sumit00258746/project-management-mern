...
const workspaceSlice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder.addCase(syncClerkWorkspace.pending, (state) => {
      state.loading = true;
    });
    builder.addCase(syncClerkWorkspace.fulfilled, (state, action) => {
    ...
    builder.addCase(syncClerkWorkspace.rejected, (state) => {
      state.loading = false;
    });
  },
});
