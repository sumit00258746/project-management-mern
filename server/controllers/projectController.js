export const createProject = async (req, res) => {
    ...
    try {
        ...
        const { workspaceId, name, description, status, start_date,
        ...
        const projectWithMembers = await prisma.project.findUnique({
            ...
            include: {
                ...
                tasks: {
                    include: { assigness: true, comments: { include: { user: true } } },
                },
                owner: true
            },
        });
...
export const updateProject = async (req, res) => {
    ...
    try {
        const { userId } = await req.auth();
        const { id, workspaceId, name, description, status, start_date,
